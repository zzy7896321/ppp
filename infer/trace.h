...
#define pp_trace_set_variable(trace, varname, variable) (variable_hash_table_put(trace->variable_map, varname, variable))

//pp_variable_t* pp_trace_get_variable(pp_trace_t* trace, const char* varname);
#define pp_trace_get_variable(trace, varname) (variable_hash_table_get_node(trace->variable_map, varname)->value)

//pp_varaible_t* pp_trace_find_variable(pp_trace_t* trace, const char* varname);
#define pp_trace_find_variable(trace, varname) (variable_hash_table_find(trace->variable_map, varname))
